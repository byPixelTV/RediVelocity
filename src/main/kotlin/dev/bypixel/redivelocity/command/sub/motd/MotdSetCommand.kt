...
object MotdSetCommand {
    fun motdSetCommand() : CommandAPICommand {
        return CommandAPICommand("set")
            .withPermission("redivelocity.command.motd.set")
            .withArguments(
            ...
            .executes(CommandExecutor { sender, args ->
                ...
                RediVelocityCoroutineScope.launch(Dispatchers.IO) {
                    ...
                    sender.sendMessage(
                        MiniMessage.miniMessage().deserialize(RediVelocity.instance.messageConfig.getString(Route.fromString("commands.redivelocity.motd.set")), Placeholder.parsed("prefix", RediVelocity.instance.messageConfig.getString(Route.fromString("prefix"))), Placeholder.unparsed("motd", motd))
                    )
                }
            })
    }
