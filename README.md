...
<a href="https://docs.bypixel.dev/redivelocity" target="_blank">
  <img src="https://github.com/intergrav/devins-badges/blob/v3/assets/cozy/documentation/generic_64h.png?raw=true" height="64" alt="spigot logo" />
</a>


![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/byPixelTV/RediVelocity/build.yml?branch=release&style=for-the-badge)
...
> - RediVelocity is only compatible with the latest version of Velocity
> - I will only support the latest release of Velocity. If you want to get official support, you have to use the latest version of **Redis, RediVelocity and Velocity!**
...
> - RediVelocity is built with **Java 25** and requires it to run, you can find the latest version of Java [here](https://adoptium.net/).
